    ...
    <div>
      <div class="max-w-screen-xl mx-auto p-5 sm:p-10 md:p-16">
        <div class="border-b mb-5 flex justify-between text-sm">
          <div class="text-orange-600 flex items-center pb-2 pr-2 border-b-2 border-indigo-600 uppercase">
            {/* <svg
                class="h-6 mr-3"
                version="1.1"
                id="Capa_1"
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-10">
          <div class="rounded overflow-hidden shadow-lg flex flex-col">
            ...
            <div class="relative">
              <a href="#">
                <img
                  class="w-full"
                  src="https://img.freepik.com/free-photo/global-business-internet-network-connection-iot-internet-things-business-intelligence-concept-busines-global-network-futuristic-technology-background-ai-generative_1258-176762.jpg?t=st=1721993387~exp=1721996987~hmac=1bdb386ad455793acb5b025358769fa9e74c6573db2de70f4dee71c5d4c28833&w=740"
                  alt="Sunset in the mountains"
                />
                <div class="hover:bg-transparent transition duration-300 absolute bottom-0 top-0 right-0 left-0 bg-gray-900 opacity-25"></div>
              </a>
              <a href="#!">
                <div class="text-xs absolute top-0 right-0 bg-orange-600 px-4 py-2 text-white mt-3 mr-3 hover:bg-white hover:text-orange-600 transition duration-500 ease-in-out">
                  Purchase
                </div>
              </a>
            </div>
            <div class="px-6 py-4 mb-auto">
              ...
              <p class="text-gray-500 text-sm">
                This course provides a comprehensive introduction to blockchain
                technology, its history, and its applications.
              </p>
            </div>
            <div class="px-6 py-3 flex flex-row items-center justify-between bg-gray-100">
              ...
              <span
                ...
                class="py-1 text-xs font-regular text-gray-900 mr-1 flex flex-row items-center"
              >
                <FiAlignJustify className="w-50 h-full" />
                <span class="">4 Lectures</span>
              </span>
            </div>
          </div>
          ...
          <div class="rounded overflow-hidden shadow-lg flex flex-col">
            ...
            <div class="px-6 py-4 mb-auto">
              ...
              <p class="text-gray-500 text-sm">
                Designed for business professionals, this course explores how
                blockchain can be used to solve business challenges and create
                new opportunities.
              </p>
            </div>
            <div class="px-6 py-3 flex flex-row items-center justify-between bg-gray-100">
          ...
          <div class="rounded overflow-hidden shadow-lg flex flex-col">
            ...
            <div class="px-6 py-4 mb-auto">
              ...
              <p class="text-gray-500 text-sm">
                Covers the principles of blockchain security, including
                cryptographic techniques and best practices to ensure secure
